...
class Contacto {
  ...
  class Agenda {
    ...
    agregarContacto(contacto) {
      ...
      if (this.existeContacto(contacto)) {
        ...
        if (!this.agendaLlena()) {
          ...
          document.write("contacto añadido");
    ...
    buscarContacto(contacto) {
      ...
      if (encontrado) {
        document.write(`contacto encontrado, Telefono: ${contacto.telefono}`);
      } else {
        document.write("Este contacto no existe");
      }
    }
    ...
    eliminarContacto(contacto) {
      ...
      document.write("contactos almacenados en la agenda" + this.contactos);
    }
    ...
    huecosLibres() {
      ...
      if (cantidadEspacios > 0)
        document.write("Cantidad de espacio disponible " + cantidadEspacios);
      else document.write("La agenda no tiene espacios libres");
    }
  }
